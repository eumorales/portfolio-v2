...
const About = () => {
  return (
    <div className="sobre flex justify-between items-center mx-auto max-w-6xl mt-12">
      <div>
        <h1 className="text-8xl font-bold text-black">Hi, I'm <strong>Gilberto</strong>.</h1>
      ...
      <div>
        <img id="sobre-img" src="assets/sobre.svg" alt="Sobre" className="max-w-full ml-20 h-auto" />
      </div>
    </div>
  );
};
