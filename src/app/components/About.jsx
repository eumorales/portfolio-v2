...
const About = () => {
  return (
    <div id="sobre" className="sobre flex flex-col md:flex-row justify-between items-center mx-auto max-w-6xl mt-12">
      <div className="md:w-1/2 md:pr-8">
        <h1 className="text-4xl md:text-8xl mt-20 font-bold text-black">Hi, I'm <strong>Gilberto</strong>.</h1>
      ...
      <div className="md:w-1/2 mt-8 md:mt-0 order-first md:order-last">
